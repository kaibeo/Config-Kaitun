...
KaitunGui.Name = "Ryzen Kaitun 3.5"
...
Title.Text = "Ryzen Kaitun | Kaitun Blox Fruit"
...
local function Hop(filterNames, maxPlayers, waitTime)
    isHopping = true
    maxPlayers = maxPlayers or 10
    waitTime = waitTime or 25
    local apiUrl = "https://dragonstoroautohopapi.up.railway.app/?key=" .. filterNames
...
FunctionsHandler.SoulGuitar:RegisterMethod('Start', function(k)
        ...
        elseif k == 2 then
            ...
            if TTL9 > 60 then return Hop("fullmoon", 10, 5) end
            local h = {}
            ...
            if #h < 6 then
                ...
                for w, D in h do
                    while task.wait() and D.Humanoid.Health > 7000 do
                        ...
                        FunctionsHandler.LocalPlayerController.Methods.EquipTool:Call('Melee')
                        if os.time() - X > 60 then Hop("fullmoon", 10, 5) end
