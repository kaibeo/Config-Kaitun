...
task.spawn(function()
	...
	if HOOK_DETECTED then
		return warn('[ Ryzen Kaitun] http_request hook detected ! Disabled all http requests')
	end
...
if not Config.UI then
	...
	discordText.Text = "discord.gg/fdyw76rTuD"
...
if PLACE_ID.sea2() and zQuestProRemote then
	local zQuestProConnection = zQuestProRemote.OnClientEvent:Connect(function(a)
		if a == "promptDialogue" then
			warn("Ryzen Kaitun : Finished cutscene")
			hopLowServer()
		end
	end)
